...
# Future Plans:
    ...
    Re-Adding back the Discord Social SDK (the Discord RPC had to be removed due to discontinuation and replacement by the discord Social/App SDKs, however, 
    there is a temporary workaround that was added).
    ...
    all 3 rendering capabilities and adding more if needed.
